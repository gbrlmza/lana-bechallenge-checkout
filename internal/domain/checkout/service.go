...
type Service interface {
	...
	BasketAddItem(ctx context.Context, basketID string, itemDetail entities.ItemDetail) error
	BasketRemoveItem(ctx context.Context, basketID string, itemDetail entities.ItemDetail) error
